...
namespace ET.Client
{
    ...
    [EntitySystemOf(typeof(GMToolsBatchViewComponent))]
    public static partial class GMToolsBatchViewComponentSystem
    {
        [EntitySystem]
        private static void Awake(this GMToolsBatchViewComponent self)
        {
        }

        [EntitySystem]
        private static void YIUIBind(this GMToolsBatchViewComponent self)
        {
            self.UIBind();
        }
        
        private static void UIBind(this GMToolsBatchViewComponent self)
        {
