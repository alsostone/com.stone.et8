...
{
    [EnableClass]
    public sealed partial class TbSkillBuffRow : BeanBase
    {
        public TbSkillBuffRow(ByteBuf _buf)
        {
            Id = _buf.ReadInt();
        ...
        public static TbSkillBuffRow DeserializeTbSkillBuffRow(ByteBuf _buf)
        {
            return new TbSkillBuffRow(_buf);
        }
        ...
        public const int __ID__ = 669673124;
