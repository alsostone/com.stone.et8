...
{
    [EnableClass]
    public sealed partial class TbSkillEffectRow : BeanBase
    {
        public TbSkillEffectRow(ByteBuf _buf)
        {
            Id = _buf.ReadInt();
        ...
        public static TbSkillEffectRow DeserializeTbSkillEffectRow(ByteBuf _buf)
        {
            return new TbSkillEffectRow(_buf);
        }
        ...
        public const int __ID__ = 2093185382;
