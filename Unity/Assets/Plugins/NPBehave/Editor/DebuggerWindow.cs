...
//            nodeTextStyle = new GUIStyle(EditorStyles.label);
        ...
        {
            float tStopRequested = Mathf.Lerp(0.85f, 0.25f, 2.0f * ((DateTime.Now.Ticks - node.DebugLastStopRequestAt) / 10000000f));
            float tStopped = Mathf.Lerp(0.85f, 0.25f, 2.0f * ((DateTime.Now.Ticks - node.DebugLastStoppedAt) / 10000000f));
