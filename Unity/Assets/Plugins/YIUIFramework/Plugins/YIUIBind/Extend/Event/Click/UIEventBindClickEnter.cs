...
namespace YIUIFramework
{
    ...
    /// </summary>
    [LabelText("点击 进入<null>")]
    [AddComponentMenu("YIUIBind/Event/点击进入 【ClickEnter】 UIEventBindClickEnter")]
    public class UIEventBindClickEnter: UIEventBind, IPointerEnterHandler
    {
        [SerializeField]
        [LabelText("可选组件")]
