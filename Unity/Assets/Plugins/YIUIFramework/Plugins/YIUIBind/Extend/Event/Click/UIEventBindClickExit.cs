...
namespace YIUIFramework
{
    ...
    /// </summary>
    [LabelText("点击 离开<null>")]
    [AddComponentMenu("YIUIBind/Event/点击离开 【ClickExit】 UIEventBindClickExit")]
    public class UIEventBindClickExit: UIEventBind, IPointerExitHandler
    {
        [SerializeField]
        [LabelText("可选组件")]
